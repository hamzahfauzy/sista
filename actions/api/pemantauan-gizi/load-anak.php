...
$where = "WHERE NIK <> '' AND TIMESTAMPDIFF (YEAR, tanggal_lahir, CURDATE()) <= 5";
...
foreach($data as $key => $d)
{
    ...
    $results[$key][] = '<a href="'.routeTo('kegiatan/pemantauan-gizi/create',$params).'" class="btn btn-success">Pilih</a>';
}
