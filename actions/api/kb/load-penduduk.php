...
$where = "WHERE NIK <> '' AND sebagai IS NOT NULL AND TIMESTAMPDIFF (YEAR, tanggal_lahir, CURDATE()) >= 17";
...
foreach($data as $key => $d)
{
    ...
    $results[$key][] = '<a href="'.routeTo('kegiatan/kb/create',$params).'" class="btn btn-success">Pilih</a>';
}
