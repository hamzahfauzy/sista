                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php endif ?>
                                            */ ?>
                                            <?php if(is_allowed(get_route_path('kegiatan/imunisasi/delete',['table'=>$table]),auth()->user->id)): ?>
                                                <a href="<?=routeTo('kegiatan/imunisasi/delete',['table'=>$table,'id'=>$data->id])?>" onclick="if(confirm('apakah anda yakin akan menghapus data ini ?')){return true}else{return false}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i> Hapus</a>
                                            <?php endif ?>
                                            </td>
                                        </tr>
                                        <?php endforeach ?>
