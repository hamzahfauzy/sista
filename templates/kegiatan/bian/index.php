            ...
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    ...
                    <div class="ml-md-auto py-2 py-md-0">
                        <?php if(is_allowed(get_route_path('kegiatan/bian/create',$_GET),auth()->user->id) && isset($_GET['posyandu_id'])): ?>
                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php endif ?>
                                            */ ?>
                                            <?php if(is_allowed(get_route_path('kegiatan/bian/delete',[]),auth()->user->id) && isset($_GET['posyandu_id'])): ?>
