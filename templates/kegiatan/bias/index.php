            ...
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    ...
                    <div class="ml-md-auto py-2 py-md-0">
                        <?php if(is_allowed(get_route_path('kegiatan/bias/create',$_GET),auth()->user->id) && isset($_GET['posyandu_id'])): ?>
                            <button class="btn btn-secondary btn-round" onclick="loadAnakBias()">Buat <?=_ucwords($table)?></button>
                            <?php 
                            /*
                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php endforeach ?>
                                            <?php /*
                                            <?php if(is_allowed(get_route_path('kegiatan/imunisasi/edit',['table'=>$table]),auth()->user->id)): $params = ['table'=>$table,'id'=>$data->id]; ?>
                                            ...
                                            <?php endif ?>
                                            */ ?>
                                            <?php if(is_allowed(get_route_path('kegiatan/bias/delete',[]),auth()->user->id) && isset($_GET['posyandu_id'])): ?>
                                                <a href="<?=routeTo('kegiatan/bias/delete',['id'=>$data->id])?>" onclick="if(confirm('apakah anda yakin akan menghapus data ini ?')){return true}else{return false}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i> Hapus</a>
                                            <?php endif ?>
                                            </td>
                                        </tr>
                                        <?php endforeach ?>
