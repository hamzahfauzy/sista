            ...
            <div class="col-sm-12 col-md-6 col-lg-4 mx-auto">
                ...
                <div class="card full-height">
                    <div class="card-body">
                        ...
                        <div class="card-title text-center">Form Lupa Password</div>
                        <div class="card-category text-center">Masukkan Email anda pada bidang di bawah ini.</div>

                        <form action="" method="post">
                            <div class="form-group">
                                <label for="">Email</label>
                                <input type="email" name="email" id="" class="form-control mb-2" placeholder="Email Disini..." required>
                                <button class="btn btn-success btn-block btn-round">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
